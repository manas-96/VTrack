                ...
                children: [
                  ...
                  Positioned(
                    ...
                    child: Container(
                      ...
                      child: widget.value? Text("OFF",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 10),)
                          :Text(""),
                    )
                  ),
                  Positioned(
                      ...
                      child: Container(
                        ...
                        child: widget.value==false? Text("ON",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 10))
                            :Text(""),
                      )
                  ),
                ],
